...
function ClerkContextProvider(props) {
  ...
  const { isomorphicClerk: clerk2, loaded: clerkLoaded2 } = useLoadedIsomorphicClerk(isomorphicClerkOptions);
  ...
  const clerkCtx = React8__default.default.useMemo(() => ({ value: clerk2 }), [clerkLoaded2]);
...
var useLoadedIsomorphicClerk = (options) => {
  const [loaded, setLoaded] = React8__default.default.useState(false);
