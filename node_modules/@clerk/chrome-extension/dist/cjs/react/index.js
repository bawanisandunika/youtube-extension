...
function ClerkContextProvider(props) {
  ...
  const { isomorphicClerk: clerk2, loaded: clerkLoaded } = useLoadedIsomorphicClerk(isomorphicClerkOptions);
  ...
  const clerkCtx = React8__default.default.useMemo(() => ({ value: clerk2 }), [clerkLoaded]);
